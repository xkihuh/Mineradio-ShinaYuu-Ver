...
(function () {
  ...
  function installStyle() {
    ...
    style.textContent = [
      ...
      '.shinayuu-update-logo{display:grid;place-items:center;width:52px;height:52px;border-radius:15px;background:linear-gradient(145deg,rgba(97,222,255,.24),rgba(136,93,255,.22));box-shadow:inset 0 0 0 1px rgba(255,255,255,.13);font:850 13px/1 Inter,sans-serif;letter-spacing:.08em;color:#fff}',
