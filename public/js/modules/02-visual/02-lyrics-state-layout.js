// ============================================================
// Original shelf/lyrics layering contract: lyrics stay above the shelf by
// default. A deliberate right-click toggles them behind the open shelf.
var shelfLyricsBehind = false;
function setShelfLyricsBehind(value) {
  shelfLyricsBehind = !!value;
  if (typeof markRenderInteraction === 'function') markRenderInteraction('shelf-lyrics-layer', 720);
  return shelfLyricsBehind;
}
function toggleShelfLyricsBehind() {
  return setShelfLyricsBehind(!shelfLyricsBehind);
}
