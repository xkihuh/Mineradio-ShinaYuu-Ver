...
async function playHomeDaily() {
  ...
  forcePlaybackControlsInteractive();
  playQueueAt(0, userPlaybackSelectionOptions()).catch(function (e) { console.warn('[HomeDailyPlay]', e); });
}
async function playHomePrivateRadio() {
  ...
  if (homeDiscoverState.songs.length) {
    ...
    forcePlaybackControlsInteractive();
    playQueueAt(0, userPlaybackSelectionOptions()).catch(function (e) { console.warn('[HomePrivatePlay]', e); });
    return;
  }
...
function playHomeSong(index) {
  ...
  forcePlaybackControlsInteractive();
  playQueueAt(currentIdx, userPlaybackSelectionOptions()).catch(function (e) { console.warn('[HomeSongPlay]', e); });
}
