...
var presetMeta = [
  ...
  { name: '音域回响', nameHtml: '音域回响 <span class="pc-name-en">Sonic-Topography</span>', desc: '作者 Ajin', descHtml: 'Tác giả <span class="pc-author-ajin">Ajin</span>' },
];
var presetIcons = [
...
function safeArchiveFileName(name) {
  return String(name || 'Bản lưu người dùng ShinaYuu Music').replace(/[\\/:*?"<>|]+/g, '-').slice(0, 48) + '.json';
}
