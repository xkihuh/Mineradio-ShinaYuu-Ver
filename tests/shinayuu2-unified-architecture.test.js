...
test('package identity is the unified ShinaYuu Music 2.1.5 release', () => {
  ...
  assert.deepEqual(pkg.shinayuu.providers.playback, ['youtube-music', 'youtube-video', 'spotify', 'soundcloud', 'local']);
