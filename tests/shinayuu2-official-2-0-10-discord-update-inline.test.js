...
test('2.0.14 embeds Discord Liquid Glass configuration directly in Advanced', () => {
...
test('2.0.14 update checker uses the real app logo, bilingual note and emoji artwork', () => {
  const html = read('public/index.html');
