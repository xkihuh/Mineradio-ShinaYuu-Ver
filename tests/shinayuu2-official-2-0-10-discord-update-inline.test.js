...
test('2.1.0 embeds Discord Liquid Glass configuration directly in Advanced', () => {
...
test('2.1.0 update checker uses the real app logo, bilingual note and emoji artwork', () => {
  const html = read('public/index.html');
