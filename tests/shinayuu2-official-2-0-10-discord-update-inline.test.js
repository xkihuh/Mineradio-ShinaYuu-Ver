...
test('2.1.1 embeds Discord Liquid Glass configuration directly in Advanced', () => {
...
test('2.1.1 update checker uses the real app logo, bilingual note and emoji artwork', () => {
  const html = read('public/index.html');
