...
test('2.1.1 serializes Spotify AutoMix volume commands instead of leaving overlapping writes', () => {
...
test('2.1.1 restores only the provider that owns audible output after AutoMix', () => {
  const mix = read('public/js/modules/05-playback/18-cuefield-automix-integration.js');
