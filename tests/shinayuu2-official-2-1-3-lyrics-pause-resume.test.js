...
test('2.1.3 keeps lyrics resident on pause without requiring an HTML audio src', () => {
...
test('2.1.3 restores the current lyric mesh directly from the provider clock on resume', () => {
  const stage = read('public/js/modules/02-visual/14-stage-lyrics-rendering.js');
...
test('2.1.3 wires HTML and Spotify pause-resume events into the same lyric lifecycle', () => {
