...
test('2.0.3 identity and installer metadata are synchronized', () => {
  assert.equal(pkg.version, '2.0.3');
  assert.equal(pkg.displayVersion, '2.0.3');
  assert.equal(pkg.shinayuu.displayVersion, '2.0.3');
  assert.equal(pkg.build.buildVersion, '2.0.3.0');
  assert.equal(lock.version, '2.0.3');
