...
test('2.1.3 keeps the stable provider playback core and applies the 2.1.3 AutoMix ownership fix', () => {
  ...
  assert.match(automix, /var VERSION = '2\.1\.3'/);
...
test('2.1.3 foreground recovery prewarms only and never replaces togglePlay', () => {
...
test('2.1.3 Discord and updater surfaces are real Liquid Glass layouts', () => {
