...
test('2.0.15 keeps the 2.0.10 AutoMix and provider playback core untouched', () => {
...
test('2.0.15 foreground recovery prewarms only and never replaces togglePlay', () => {
...
test('2.0.15 Discord and updater surfaces are real Liquid Glass layouts', () => {
