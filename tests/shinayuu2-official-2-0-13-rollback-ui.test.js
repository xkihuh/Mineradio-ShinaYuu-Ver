...
test('2.1.1 keeps the stable provider playback core and applies the 2.1.1 AutoMix ownership fix', () => {
  ...
  assert.match(automix, /var VERSION = '2\.1\.1'/);
...
test('2.1.1 foreground recovery prewarms only and never replaces togglePlay', () => {
...
test('2.1.1 Discord and updater surfaces are real Liquid Glass layouts', () => {
