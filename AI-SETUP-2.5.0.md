# ShinaYuu Music 2.5.0 — AI Multi-Provider Setup
...
$env:SHINAYUU_AI_ADAPTIVE_MEMORY="true"
$env:SHINAYUU_AI_CONVERSATION_MEMORY="true"
$env:SHINAYUU_AI_PREFERENCE_RERANKING="true"
$env:SHINAYUU_AI_SMART_NEXT="true"
...
[Environment]::SetEnvironmentVariable("SHINAYUU_AI_ADAPTIVE_MEMORY","true","User")
[Environment]::SetEnvironmentVariable("SHINAYUU_AI_CONVERSATION_MEMORY","true","User")
[Environment]::SetEnvironmentVariable("SHINAYUU_AI_PREFERENCE_RERANKING","true","User")
[Environment]::SetEnvironmentVariable("SHINAYUU_AI_SMART_NEXT","true","User")
...
## G. Personal Music Agent 4.1 in 2.5.0

The AI Core 4.1 layer adds rolling conversation context, playback-behavior learning, personalized provider-result re-ranking, deterministic Smart Next, intent planning, bounded multi-step tool orchestration, recommendation quality verification, and safe final-action verification. These features are enabled by default together with AI memory and can be disabled independently with the `SHINAYUU_AI_ADAPTIVE_MEMORY`, `SHINAYUU_AI_CONVERSATION_MEMORY`, `SHINAYUU_AI_PREFERENCE_RERANKING`, and `SHINAYUU_AI_SMART_NEXT` environment variables.


### AI 4.1 controls
`SHINAYUU_AI_AGENT_PLANNING`, `SHINAYUU_AI_AGENT_VERIFICATION`, and `SHINAYUU_AI_AGENT_MAX_TOOL_ROUNDS` control planning, verification, and maximum tool-loop depth.
